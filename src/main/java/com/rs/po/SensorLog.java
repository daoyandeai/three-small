 ...
 * @Description: 
 * @Author sven
 * @DateTime 2020年1月6日 下午6:03:36
 */
public class SensorLog extends BasePo<SensorLog>{
	...
	public String getSensor_numbers() {
		return sensor_numbers;
	}
	public void setSensor_numbers(String sensor_numbers) {
		this.sensor_numbers = sensor_numbers;
	}
