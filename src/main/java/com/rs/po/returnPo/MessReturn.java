...
/**
 * 平台消息推送实体类
 * @ClassName: MessReturn
 * @Description: 
 * @Author sven
 * @DateTime 2020年2月25日 下午5:49:59
 */
public class MessReturn implements Serializable{
	/**
	 ...
	 * 自动提醒（1：是、2：否）
	 */
	private String mess_warn_state;
	/**
	 * 新增用户系统编码
	 */
	...
	public String getMess_warn_state() {
		return mess_warn_state;
	}
	public void setMess_warn_state(String mess_warn_state) {
