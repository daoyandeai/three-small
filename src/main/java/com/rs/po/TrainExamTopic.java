...
/**
 * 培训试题题目
 * @ClassName: TrainExamTopic
 * @Description: 
 * @Author sven
 * @DateTime 2019年12月10日 下午2:36:57
 */
public class TrainExamTopic extends BasePo<TrainExamTopic> {
	...
	/******************数据库辅助字段*************************/
	private List<TrainExamTopic> trainexamtopiclist;
	...
	public List<TrainExamTopic> getTrainexamtopiclist() {
		return trainexamtopiclist;
	}
	public void setTrainexamtopiclist(List<TrainExamTopic> trainexamtopiclist) {
		this.trainexamtopiclist = trainexamtopiclist;
	}
}
