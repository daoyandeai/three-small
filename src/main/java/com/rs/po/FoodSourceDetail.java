...
/**
 * 
 * @ClassName: FoodSourceDetail
 * @Description: 食材溯源实体
 * @Author tangsh
 * @DateTime 2020年3月9日 上午11:10:22
 */
public class FoodSourceDetail extends BasePo<FoodSourceDetail> implements Serializable {
     ...
     * 溯源明细附近集合
     */
    private List<FoodSourceAccessory> food_source_accessory_list;
	...
	public List<FoodSourceAccessory> getFood_source_accessory_list() {
		return food_source_accessory_list;
	}

	public void setFood_source_accessory_list(List<FoodSourceAccessory> food_source_accessory_list) {
